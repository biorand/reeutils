    ...
    public class RszTypeCsharpWriter
    {
        ...
        private string GetFieldTypeName(RszTypeField field)
        {
            ...
            return field.Type switch
            {
                ...
                RszFieldType.Uint2 => "via.Uint2",
                RszFieldType.Uint3 => "via.Uint3",
                RszFieldType.Uint4 => "via.Uint4",
                RszFieldType.Int2 => "via.Int2",
                RszFieldType.Int3 => "via.Int3",
                RszFieldType.Int4 => "via.Int4",
                RszFieldType.Color => "via.Color",
                RszFieldType.AABB => "via.AABB",
                RszFieldType.Capsule => "via.Capsule",
                RszFieldType.TaperedCapsule => "via.TaperedCapsule",
                RszFieldType.Cone => "via.Cone",
                RszFieldType.Line => "via.Line",
                RszFieldType.LineSegment => "via.LineSegment",
                RszFieldType.OBB => "via.OBB",
                RszFieldType.Plane => "via.Plane",
                RszFieldType.PlaneXZ => "via.PlaneXZ",
                RszFieldType.Point => "via.Point",
                RszFieldType.Range => "via.Range",
                RszFieldType.RangeI => "via.RangeI",
                RszFieldType.Ray => "via.Ray",
                RszFieldType.RayY => "via.RayY",
                RszFieldType.Segment => "via.Segment",
                RszFieldType.Size => "via.Size",
                RszFieldType.Sphere => "via.Sphere",
                RszFieldType.Triangle => "via.Triangle",
                RszFieldType.Cylinder => "via.Cylinder",
                RszFieldType.Ellipsoid => "via.Ellipsoid",
                RszFieldType.Area => "via.Area",
                RszFieldType.Torus => "via.Torus",
                RszFieldType.Rect => "via.Rect",
                RszFieldType.Rect3D => "via.Rect3D",
                RszFieldType.Frustum => "via.Frustum",
                RszFieldType.KeyFrame => "via.KeyFrame",
                RszFieldType.Sfix => "via.sfix",
                RszFieldType.Sfix2 => "via.Sfix2",
                RszFieldType.Sfix3 => "via.Sfix3",
                RszFieldType.Sfix4 => "via.Sfix4",
                RszFieldType.Position => "via.Position",
