...
namespace IntelOrca.Biohazard.REE.Rsz
{
    ...
    public struct AABB
    {
        ...
        public static readonly AABB MaxMin = new AABB(new System.Numerics.Vector3(float.MaxValue), new System.Numerics.Vector3(float.MinValue));
        public static readonly AABB MinMax = new AABB(new System.Numerics.Vector3(float.MinValue), new System.Numerics.Vector3(float.MaxValue));
        public static readonly AABB Invalid = new AABB(new System.Numerics.Vector3(float.MaxValue), new System.Numerics.Vector3(float.MaxValue));
...
#pragma warning restore CS8981
    ...
    public class GameObjectRef
    {
        ...
        public GameObjectRef(Guid guid, RszGameObject target)
        {
            this.guid = guid;
            this.target = target;
        }
        ...
        public void Set(Guid guid, RszGameObject target)
        {
            this.guid = guid;
            this.target = target;
        }
