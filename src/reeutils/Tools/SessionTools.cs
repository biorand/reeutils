...
namespace IntelOrca.Biohazard.REEUtils.Tools
{
    ...
    {
        [McpServerTool(Name = "get_engine_details"), Description("Gets embedded RE Engine documentation in markdown format.")]
        public static string GetEngineDetails()
        {
            return McpEmbeddedData.GetEngineDetailsMarkdown();
        }

        [McpServerTool(Name = "open_pak"), Description("Opens a pak file or RE Engine install directory for subsequent MCP tools.")]
        ...
        [McpServerTool(Name = "open_rsz"), Description("Loads an RSZ type repository from a .json or .json.gz file.")]
        ...
        [McpServerTool(Name = "open_pak_list"), Description("Loads a pak list from a .txt or .gz file.")]
        ...
        [McpServerTool(Name = "list_games"), Description("Lists the supported embedded RE Engine games.")]
        ...
        [McpServerTool(Name = "set_game"), Description("Sets the active game using embedded RSZ and pak-list data.")]
